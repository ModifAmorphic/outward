namespace ModifAmorphic.Outward.Modules.Crafting.CompatibleIngredients
{
    public interface ICompatibleIngredientMatcher
    {
        ...
        /// </summary>
        /// <param name="potentialIngredient">The ingredient to match.</param>
        ...
        bool TryMatchRecipeStep(CompatibleIngredient potentialIngredient, RecipeIngredient recipeStep, out bool isMatch);
    }
}
