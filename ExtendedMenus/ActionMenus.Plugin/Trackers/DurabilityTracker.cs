...
{
    internal class DurabilityTracker : IBarProgress
    {
        ...
        public DurabilityTracker(EquipmentSlotAction equipSlotAction, BarPositions barPosition) => (_equipSlotAction, _equipment, _barPosition, IsEnabled) = (equipSlotAction, equipSlotAction.ActionEquipment, barPosition, true);
