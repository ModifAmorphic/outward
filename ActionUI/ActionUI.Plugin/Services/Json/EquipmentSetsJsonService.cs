...
namespace ModifAmorphic.Outward.UI.Services
{
    ...
    public class EquipmentSetsJsonService : IPositionsProfileService, IDisposable
    {
        ...
        public EquipmentSetsJsonService(ProfileService profileService, Func<IModifLogger> getLogger)
        {
