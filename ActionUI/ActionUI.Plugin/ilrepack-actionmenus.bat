...
copy bin\Debug\netstandard2.0\publish\ilrepack\ModifAmorphic.Outward.ActionUI.dll C:\Users\Justin\AppData\Roaming\r2modmanPlus-local\OutwardDe\profiles\Debugging\BepInEx\plugins\ModifAmorphic-ActionUI\ModifAmorphic.Outward.ActionMenus.dll /Y
